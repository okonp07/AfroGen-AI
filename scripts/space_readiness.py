...
def main() -> None:
    ...
    print("Suggested Space repo: okonp007/AfroGen-AI")
    print("Suggested model repo: okonp007/afrogen-models")
    print("Recommended env vars:")
    print("  AFROGEN_BACKEND=synthetic")
    print("  AFROGEN_ARTIFACT_PATH=hf://okonp007/afrogen-models/trained_backend_stub.json")
